...
public class RestClientProcessorIT {
    ...
    public void shouldCallRestServiceWithNoParameters() throws Exception {
        ...
        validateResponse(restClientProcessor.request(endpointDefinition, requestEnvelopeParamAParamB()));
    }
    ...
    public void shouldHandleRemoteResponseWithMetadata() throws Exception {
        ...
        validateResponse(restClientProcessor.request(endpointDefinition, requestEnvelopeParamAParamC()));
    }
    ...
    public void shouldHandleRemoteResponseWithoutMetadata() throws Exception {
        ...
        stubFor(get(urlPathEqualTo(path))
                ...
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", mimetype)
                        .withBody(jsonFromFile(RESPONSE_WITHOUT_METADATA_FILE_NAME))));
    ...
    private void validateResponse(JsonEnvelope response) {
